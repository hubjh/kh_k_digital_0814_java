...
Date : 2023-08-30
Author : J.H.Hwang
Purpose :  자바 배열 리스트를 설명하는 프로그램입니다.
 */
...
public class ListEx1 {
    public static void main(String[] args) {
        String[] arr = {"1000", "2000", "3000", "10", "9999", "345"}; // Arrays.asList(arr) : 이미 만들어진 배열을 ArrayList에 추가
...
//        System.out.println("삭제 성공 여부 확인 : " + list.remove("200"));
