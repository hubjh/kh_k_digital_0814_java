...
public class CarMain {
    public static void main(String[] args) {
        ...
        System.out.print("[1]부산 [2]대전 [3]강릉 [4]광주 : "); int region = sc.nextInt();
        System.out.print("이동할 승객 수 입력 : "); int numOfPas= sc.nextInt();
        System.out.print("이동할 차량 선택 [1]스포츠카 [2]승용차 [3]버스 : "); int vehicle = sc.nextInt();
        sc.nextLine();
        System.out.print("[1]ON [2]OFF : "); String function= sc.next();
